...
public class SSLServer
{
	public static void main (String [] argv) throws Exception
	{
		...
		System.setProperty("javax.net.ssl.keyStorePassword", "Studium2020;");
		...
		try
		{
			...
			int numClient = 1;
			System.out.println("Servidor iniciado, bienvenido.");
			System.out.println("");
			while(true)
			{
		...
		{
			System.out.println ( "Error en los comuncacions:" + ex);
		}
	}
}
